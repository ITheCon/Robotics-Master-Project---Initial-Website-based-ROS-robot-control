...
// Initial code from tutorial below -->
...
function sendRosserviceCall() {
    ...
    var pickClient = new ROSLIB.Service({
        ...
        ros : ros,
        name : '/pick_gui',
        serviceType : '/home/cks/tiago_public_ws/src/masters_project/src/pick_client'
    });
...
window.onload = function () {
    ...
    video.src = "http://" + robot_IP + ":8080/stream?topic=/xtion/rgb/image_raw&type=mjpeg&quality=80";
